import{$ as e,B as t,D as n,G as r,H as i,N as a,R as o,S as s,T as c,U as l,V as u,X as d,Z as f,_ as p,b as m,d as h,et as g,f as _,g as v,n as y,tt as b,v as x,w as S,y as C}from"../chunks/gxaokRQK.js";import{t as w}from"../chunks/DV74Gku2.js";import"../chunks/CsaauQz1.js";import"../chunks/BxhM4Pwt.js";import{a as T,i as E}from"../chunks/DH-uP65Y.js";var D=s(`<div style="
  ...
  "><strong>📱 Mode hors-ligne</strong> — Toutes vos données sont sauvegardées localement sur votre appareil. L'application fonctionne sans connexion internet.</div></div>`);function P(s,S){f(S,!0);let P=l(u([])),F=l(null),I=l(!0);y(async()=>{await(async e=>{var t=b(e,2);i(P,t[0],!0),i(F,t[1],!0)})(await Promise.all([E(),T()])),i(I,!1)});function L(e){return n(P).filter(t=>t.statut===e).length}function R(e){switch(e){case`complete`:return`badge-green`;case`brouillon`:return`badge-yellow`;case`archive`:return`badge-gray`;default:return`badge-gray`}}function z(e){switch(e){case`complete`:return`✅ Complété`;case`brouillon`:return`✏️ Brouillon`;case`archive`:return`📦 Archivé`;default:return e}}let B=r(()=>n(P).slice(0,5));var V=N(),H=o(V),U=o(H),W=o(U),G=o(W);g(W),e(4),g(U),e(2),g(H);var K=t(H,2);v(K,21,()=>[{val:n(P).length,lbl:`Total tirs`,sub:`Journaux enregistrés`,color:`var(--accent2)`},{val:L(`complete`),lbl:`Complétés`,sub:`Prêts pour signature`,color:`var(--green)`},{val:L(`brouillon`),lbl:`Brouillons`,sub:`En cours`,color:`var(--yellow)`},{val:n(P).filter(e=>e.date_tir===new Date().toISOString().split(`T`)[0]).length,lbl:`Aujourd'hui`,sub:`Tirs ce jour`,color:`var(--orange)`}],p,(e,r)=>{var i=D(),s=o(i),c=o(s,!0);g(s);var l=t(s,2),u=o(l,!0);g(l);var d=t(l,2),f=o(d,!0);g(d),g(i),a(()=>{h(s,`font-size: 28px; font-weight: 800; color: ${n(r).color??``};`),C(c,n(r).val),C(u,n(r).lbl),C(f,n(r).sub)}),m(e,i)}),g(K);var q=t(K,2),J=t(o(q),2),Y=o(J),X=t(Y,2),Z=t(X,2),Q=t(o(Z),4),$=o(Q,!0);g(Q),g(Z);var ee=t(Z,2);g(J),g(q);var te=t(q,2),ne=e=>{var r=A(),i=t(o(r),2);v(i,17,()=>n(B),p,(e,r)=>{var i=O(),s=t(o(i),2),l=o(s),u=o(l,!0);g(l);var d=t(l,2),f=o(d);g(d),g(s);var p=t(s,2),h=o(p,!0);g(p),g(i),a((e,t)=>{C(u,n(r).numero_tir||`Sans nom`),C(f,`${(n(r).chantier||`Chantier non défini`)??``} · ${(n(r).date_tir||`—`)??``}`),_(p,1,`badge ${e??``}`),C(h,t)},[()=>R(n(r).statut),()=>z(n(r).statut)]),c(`click`,i,()=>w(`/journal/${n(r).id}`)),m(e,i)});var s=t(i,2),l=e=>{var t=k(),r=o(t);g(t),a(()=>C(r,`Voir tous les ${n(P).length??``} journaux →`)),c(`click`,t,()=>w(`/historique`)),m(e,t)};x(s,e=>{n(P).length>5&&e(l)}),g(r),m(e,r)},re=e=>{var n=j(),r=t(o(n),6);g(n),c(`click`,r,()=>w(`/journal/new`)),m(e,n)},ie=e=>{m(e,M())};x(te,e=>{!n(I)&&n(P).length>0?e(ne):n(I)?e(ie,-1):e(re,1)}),e(2),g(V),a(()=>{C(G,`Bienvenue${n(F)?`, ${n(F).prenom}`:``}`),C($,n(F)?`${n(F).prenom} ${n(F).nom}`:`Configurer`)}),c(`click`,Y,()=>w(`/journal/new`)),c(`click`,X,()=>w(`/historique`)),c(`click`,Z,()=>w(`/profil`)),c(`click`,ee,()=>w(`/historique?export=true`)),m(s,V),d()}S([`click`]);export{P as component};