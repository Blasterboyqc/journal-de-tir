...
import{B as e,D as t,G as n,H as r,N as i,R as a,S as o,T as s,U as c,V as l,X as u,Z as d,_ as f,b as p,d as m,et as h,f as g,g as _,n as v,o as y,s as b,v as x,w as S,x as C,y as w,z as T}from"../chunks/gxaokRQK.js";import{t as E}from"../chunks/B6CHAV79.js";import{t as D}from"../chunks/Di6zslmw.js";import"../chunks/CsaauQz1.js";import"../chunks/KsFD3TGQ.js";import{t as O}from"../chunks/nnJPwGW4.js";import{i as k,t as ee}from"../chunks/DH-uP65Y.js";var te=o(`<button> </button>`),ne=o(`<div style="text-align: center; padding: 40px; color: var(--text3);">Chargement...</div>`),A=o(`<div style="font-size: 48px; margin-bottom: 12px;">📋</div> <div style="font-size: 16px; font-weight: 700; color: var(--text); margin-bottom: 6px;">Aucun journal</div> <div style="font-size: 13px; color: var(--text3); margin-bottom: 16px;">Créez votre premier journal de tir</div> <button class="btn btn-primary">✏️ Créer maintenant</button>`,1),j=o(`<div style="font-size: 13px; color: var(--text3);"> </div>`),M=o(`<div style="
  ...
  "><input type="text" placeholder="🔍 Rechercher par numéro, chantier, date..." style="margin-bottom: 8px;"/> <div style="display: flex; gap: 8px; flex-wrap: wrap;"></div></div> <button class="btn btn-primary btn-full" style="margin-bottom: 12px;">✏️ Nouveau journal de tir</button> <!></div>`);function I(o,S){d(S,!0);let I=c(l([])),L=c(!0),R=c(``),z=c(`tous`),B=c(null);v(async()=>{r(I,await k(),!0),r(L,!1)});let V=n(()=>t(I).filter(e=>{let n=!t(R)||e.numero_tir?.toLowerCase().includes(t(R).toLowerCase())||e.chantier?.toLowerCase().includes(t(R).toLowerCase())||e.date_tir?.includes(t(R))||e.boutefeu_nom?.toLowerCase().includes(t(R).toLowerCase()),r=t(z)===`tous`||e.statut===t(z);return n&&r}));function H(e){switch(e){case`complete`:return`badge-green`;case`brouillon`:return`badge-yellow`;case`archive`:return`badge-gray`;default:return`badge-gray`}}function U(e){switch(e){case`complete`:return`✅ Complété`;case`brouillon`:return`✏️ Brouillon`;case`archive`:return`📦 Archivé`;default:return e}}async function W(e){confirm(`Supprimer "${e.numero_tir}"? Cette action est irréversible.`)&&(await ee(e.id),r(I,t(I).filter(t=>t.id!==e.id),!0),O(`🗑️ Journal supprimé`,`info`))}async function G(e){r(B,e.id,!0);try{let{exportJournalPDF:t}=await D(async()=>{let{exportJournalPDF:e}=await import(`../chunks/-Uo1-QJh.js`);return{exportJournalPDF:e}},__vite__mapDeps([0,1]),import.meta.url);await t(e),O(`📄 PDF téléchargé!`,`success`)}catch{O(`Erreur export PDF`,`error`)}finally{r(B,null)}}function K(e){if(!e)return`—`;try{return new Date(e).toLocaleDateString(`fr-CA`,{day:`2-digit`,month:`short`,year:`numeric`})}catch{return e}}var q=F(),J=a(q),Y=e(a(J),2),re=a(Y);h(Y),h(J);var X=e(J,2),Z=a(X);b(Z);var Q=e(Z,2);_(Q,20,()=>[{val:`tous`,label:`Tous`},{val:`brouillon`,label:`✏️ Brouillons`},{val:`complete`,label:`✅ Complétés`},{val:`archive`,label:`📦 Archivés`}],f,(e,n)=>{var o=te(),c=a(o,!0);h(o),i(()=>{m(o,`
            ...
            font-family: inherit;
          `),w(c,n.label)}),s(`click`,o,()=>r(z,n.val,!0)),p(e,o)}),h(Q),h(X);var $=e(X,2),ie=e($,2),ae=e=>{p(e,ne())},oe=n=>{var r=M(),o=a(r),c=t=>{var n=A();s(`click`,e(T(n),6),()=>E(`/journal/new`)),p(t,n)},l=e=>{var n=j(),r=a(n);h(n),i(()=>w(r,`Aucun résultat pour "${t(R)??``}"`)),p(e,n)};x(o,e=>{t(I).length===0?e(c):e(l,-1)}),h(r),p(n,r)},se=n=>{var r=C();_(T(r),17,()=>t(V),f,(n,r)=>{var o=P(),c=a(o),l=e(a(c),2),u=a(l),d=a(u,!0);h(u);var f=e(u,2),_=a(f);h(f);var v=e(f,2),y=e=>{var n=N(),o=a(n);h(n),i(()=>w(o,`👷 ${t(r).boutefeu_prenom??``} ${t(r).boutefeu_nom??``}`)),p(e,n)};x(v,e=>{t(r).boutefeu_nom&&e(y)}),h(l);var b=e(l,2),S=a(b,!0);h(b),h(c);var C=e(c,2),T=a(C),D=e(T,2),O=a(D,!0);h(D);var k=e(D,2);h(C),h(o),i((e,n,i)=>{m(o,`
        background: var(--card); border: 1px solid var(--border); border-radius: var(--radius);
        margin-bottom: 10px; overflow: hidden;
        border-left: 3px solid ${t(r).statut===`complete`?`var(--green)`:t(r).statut===`brouillon`?`var(--yellow)`:`var(--border)`};
      `),w(d,t(r).numero_tir||`Sans numéro`),w(_,`${(t(r).chantier||`Chantier —`)??``} · ${e??``}`),g(b,1,`badge ${n??``}`),w(S,i),D.disabled=t(B)===t(r).id,w(O,t(B)===t(r).id?`⏳`:`📄 PDF`)},[()=>K(t(r).date_tir),()=>H(t(r).statut),()=>U(t(r).statut)]),s(`click`,c,()=>E(`/journal/${t(r).id}`)),s(`click`,T,()=>E(`/journal/${t(r).id}`)),s(`click`,D,()=>G(t(r))),s(`click`,k,()=>W(t(r))),p(n,o)}),p(n,r)};x(ie,e=>{t(L)?e(ae):t(V).length===0?e(oe,1):e(se,-1)}),h(q),i(()=>w(re,`${t(I).length??``} journal${t(I).length===1?``:`x`} au total`)),y(Z,()=>t(R),e=>r(R,e)),s(`click`,$,()=>E(`/journal/new`)),p(o,q),u()}S([`click`]);export{I as component};