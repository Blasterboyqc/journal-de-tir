import{B as e,C as t,E as n,F as r,H as i,J as a,L as o,M as s,N as c,Q as l,R as u,T as d,U as f,V as p,Y as m,Z as h,_ as g,a as _,b as v,c as y,d as b,g as ee,h as x,l as S,o as C,r as w,u as T,v as E,w as D,x as O,y as k,z as A}from"./Dpq0MdiO.js";import"./CT0T0Gak.js";import{o as te}from"./BfYHUnu2.js";var j=O(`<div style="font-size: 13px; color: var(--text); padding: 6px 0;"> </div>`),M=O(`<input type="text" placeholder="ex: 2.5m SOL / 8.5m ROC" style="font-size: 12px;"/>`),N=O(`<div style="font-size: 13px; color: var(--text); padding: 6px 0;"> </div>`),P=O(`<input type="text" placeholder="ex: Emulite 100, 70mm" style="font-size: 12px;"/>`),F=O(`<div style="
...
"><div style="
  ...
  "> </div> <div style="padding: 10px;"><div style="margin-bottom: 8px;"><label style="font-size: 10px; font-weight: 600; color: var(--text3); text-transform: uppercase; letter-spacing: 0.4px; display: block; margin-bottom: 3px;">Profondeur des forages: SOL/ROC (incluant mort terrain)</label> <!></div> <div style="margin-bottom: 10px;"><label style="font-size: 10px; font-weight: 600; color: var(--text3); text-transform: uppercase; letter-spacing: 0.4px; display: block; margin-bottom: 3px;">Chargement-Type</label> <!></div> <div style="display: flex; gap: 8px; margin-bottom: 10px;"><div style="
    ...
    "><span style="font-size: 11px; color: var(--text3); font-weight: 600; white-space: nowrap;">Trous n°:</span> <!></div></div></div>`);function oe(e,t){m(t,!0);let i=_(t,`schema`,15),c=_(t,`readonly`,3,!1),d=f(()=>i().couches?i().couches.split(`
`).filter(e=>e.trim()):[]);var p=B(),b=o(p),C=o(b);l(b);var w=A(b,2),D=o(w),O=o(D),te=A(O,2),oe=e=>{var t=j(),n=o(t,!0);l(t),s(()=>E(n,i().profondeur_sol_roc||`—`)),k(e,t)},se=e=>{var n=M();S(n),s(()=>T(n,`id`,`prof_${t.index??``}`)),y(n,()=>i().profondeur_sol_roc,e=>i(i().profondeur_sol_roc=e,!0)),k(e,n)};g(te,e=>{c()?e(oe):e(se,-1)}),l(D);var ce=A(D,2),le=o(ce),ue=A(le,2),de=e=>{var t=N(),n=o(t,!0);l(t),s(()=>E(n,i().chargement_type||`—`)),k(e,t)},fe=e=>{var n=P();S(n),s(()=>T(n,`id`,`ct_${t.index??``}`)),y(n,()=>i().chargement_type,e=>i(i().chargement_type=e,!0)),k(e,n)};g(ue,e=>{c()?e(de):e(fe,-1)}),l(ce);var pe=A(ce,2),me=o(pe),he=o(me),ge=e=>{var t=v();x(u(t),17,()=>n(d),ee,(e,t)=>{var r=F(),i=A(o(r),2),a=o(i,!0);l(i),l(r),s(()=>E(a,n(t))),k(e,r)}),k(e,t)},_e=e=>{k(e,I())};g(he,e=>{n(d).length>0?e(ge):c()||e(_e,1)}),l(me),h(2),l(pe);var ve=A(pe,4),ye=o(ve),be=A(ye,2),xe=e=>{var t=L(),n=o(t,!0);l(t),s(()=>E(n,i().bourre||`—`)),k(e,t)},Se=e=>{var n=ne();S(n),s(()=>T(n,`id`,`bourre_${t.index??``}`)),y(n,()=>i().bourre,e=>i(i().bourre=e,!0)),k(e,n)};g(be,e=>{c()?e(xe):e(Se,-1)}),l(ve);var Ce=A(ve,2),we=o(Ce),Te=A(we,2),Ee=e=>{var t=re(),n=o(t,!0);l(t),s(()=>E(n,i().explosifs_amorces||`—`)),k(e,t)},De=e=>{var n=ie();S(n),s(()=>T(n,`id`,`expl_${t.index??``}`)),y(n,()=>i().explosifs_amorces,e=>i(i().explosifs_amorces=e,!0)),k(e,n)};g(Te,e=>{c()?e(Ee):e(De,-1)}),l(Ce);var V=A(Ce,2),H=e=>{var n=ae(),a=o(n),c=A(a,2);r(c),l(n),s(()=>{T(a,`for`,`couches_${t.index??``}`),T(c,`id`,`couches_${t.index??``}`)}),y(c,()=>i().couches,e=>i(i().couches=e,!0)),k(e,n)};g(V,e=>{c()||e(H)});var U=A(V,2),W=A(o(U),2),G=e=>{var t=R(),n=u(t),r=o(n,!0);l(n);var a=A(n,4),c=o(a,!0);l(a),s(()=>{E(r,i().trous_de||`___`),E(c,i().trous_a||`___`)}),k(e,t)},K=e=>{var t=z(),n=u(t);S(n);var r=A(n,4);S(r),y(n,()=>i().trous_de,e=>i(i().trous_de=e,!0)),y(r,()=>i().trous_a,e=>i(i().trous_a=e,!0)),k(e,t)};g(W,e=>{c()?e(G):e(K,-1)}),l(U),l(w),l(p),s(()=>{E(C,`Schéma #${t.index+1} — Disposition des trous de mine / Séquence de mise à feu`),T(O,`for`,`prof_${t.index??``}`),T(le,`for`,`ct_${t.index??``}`),T(ye,`for`,`bourre_${t.index??``}`),T(we,`for`,`expl_${t.index??``}`)}),k(e,p),a()}var se=O(`<div style="margin-top: 4px; font-size: 11px; color: var(--text3);" class="svelte-118nmc4">→ Ajoutez votre clé API dans l'onglet <strong class="svelte-118nmc4">Profil</strong></div>`),ce=O(`<div style="
      ...
      " class="svelte-118nmc4">📷 Appuyez pour prendre ou sélectionner une photo <input type="file" accept="image/*" capture="environment" style="display: none;" class="svelte-118nmc4"/></label>`),de=O(`<div style="
    ...
    " class="svelte-118nmc4"><div style="font-size: 16px; font-weight: 800; color: var(--text);" class="svelte-118nmc4"> </div> <button style="
        ...
        " class="svelte-118nmc4">✕ Fermer</button></div> <div style="padding: 14px 16px;" class="svelte-118nmc4"><div style="margin-bottom: 14px;" class="svelte-118nmc4"><div style="font-size: 11px; font-weight: 700; color: var(--text3); text-transform: uppercase; letter-spacing: 0.5px; margin-bottom: 8px;" class="svelte-118nmc4">Délai (ms)</div> <div style="display: flex; align-items: center; gap: 8px;" class="svelte-118nmc4"><button style="
          ...
          " class="svelte-118nmc4"/></div> <div style="display: flex; gap: 8px;" class="svelte-118nmc4"><button style="
            ...
            background: var(--card2); border: 1px solid var(--border); color: var(--text2);
            cursor: pointer; font-family: inherit; text-align: center;
          " class="svelte-118nmc4">📍 Déplacer</button> <!></div></div></div>`),Ee=O(`<div style="width: 100%;" class="svelte-118nmc4"><!> <!> <div class="svelte-118nmc4"><canvas style="display: block; width: 100%; touch-action: none;" class="svelte-118nmc4"></canvas> <!> <!></div> <!> <!></div> <!>`,1);function De(t,r){m(r,!0);let h=_(r,`holes`,31,()=>e([])),T=_(r,`connections`,31,()=>e([])),O=_(r,`dataurl`,15,``),j=_(r,`readonly`,3,!1),M=i(`none`),N=i(null),P=i(null),F=i(!1),I=i(!1),L=i(null),ne=i(0),re=i(0),ie=i(!1),ae=null,R=i(`grille`),z=i(3),B=i(4),oe=i(3.5),De=i(3),V=i(25),H=i(!1),U=i(``),W=i(null),G=[],K,q,Oe=f(()=>h().length>0?Math.max(...h().map(e=>e.id))+1:1),J=i(!1);function Y(){G.push({holes:h().map(e=>({...e})),connections:T().map(e=>({...e}))}),G.length>20&&G.shift()}function ke(){if(G.length===0)return;let e=G.pop();h(e.holes),T(e.connections),Z()}function Ae(){confirm(`Effacer tous les trous?`)&&(Y(),h([]),T([]),Z())}function je(){Y(),h(h().map((e,t)=>({...e,label:String(t+1)}))),Z()}function Me(){Y(),h(h().map((e,t)=>({...e,delay_ms:t*25}))),Z()}let Ne=`#f5c518`;function Pe(){if(!q)return{w:300,h:200};let e=q.clientWidth;return{w:e,h:Math.round(2/3*e)}}function Fe(){if(!K||!q)return;let e=window.devicePixelRatio||1,{w:t,h:n}=Pe();K.width=Math.round(t*e),K.height=Math.round(n*e),K.style.width=`${t}px`,K.style.height=`${n}px`,K.getContext(`2d`).scale(e,e),X()}function X(){if(!K)return;let e=K.getContext(`2d`),t=window.devicePixelRatio||1,r=K.width/t,i=K.height/t;e.fillStyle=`#0f1117`,e.fillRect(0,0,r,i),e.strokeStyle=`rgba(255,255,255,0.07)`,e.lineWidth=.5;for(let t=0;t<=r;t+=24)e.beginPath(),e.moveTo(t,0),e.lineTo(t,i),e.stroke();for(let t=0;t<=i;t+=24)e.beginPath(),e.moveTo(0,t),e.lineTo(r,t),e.stroke();n(I)&&(e.strokeStyle=Ne,e.lineWidth=3,e.strokeRect(2,2,r-4,i-4)),e.setLineDash([4,4]),e.strokeStyle=`rgba(160,168,204,0.5)`,e.lineWidth=1.5;for(let t of T()){let n=h().find(e=>e.id===t.from),a=h().find(e=>e.id===t.to);n&&a&&(e.beginPath(),e.moveTo(n.x*r,n.y*i),e.lineTo(a.x*r,a.y*i),e.stroke())}e.setLineDash([]);for(let t of h()){let a=t.x*r,o=t.y*i,s=t.id===n(N)||t.id===n(L),c=n(I)&&t.id===n(L);s&&(e.shadowColor=c?Ne:`#6c84f8`,e.shadowBlur=16),e.beginPath(),e.arc(a,o,22,0,Math.PI*2),e.fillStyle=s?`#6c84f8`:`#4f6ef7`,e.fill(),e.strokeStyle=c?Ne:s?`#ffffff`:`rgba(255,255,255,0.3)`,e.lineWidth=s?3:1.5,e.stroke(),e.shadowBlur=0,e.shadowColor=`transparent`,e.fillStyle=`#ffffff`,e.font=`bold ${t.label.length>2?`12`:`14`}px system-ui, sans-serif`,e.textAlign=`center`,e.textBaseline=`middle`,e.fillText(t.label,a,o),t.delay_ms>=0&&(e.fillStyle=`rgba(220,228,255,0.9)`,e.font=`bold 11px system-ui, sans-serif`,e.textAlign=`center`,e.textBaseline=`top`,e.fillText(`${t.delay_ms}ms`,a,o+22+4))}e.textBaseline=`alphabetic`}function Z(){X(),K&&O(K.toDataURL(`image/png`))}function Ie(e,t){let n=K.getBoundingClientRect();return{nx:(e-n.left)/n.width,ny:(t-n.top)/n.height}}function Le(e,t){let{w:n,h:r}=Pe(),i=e*n,a=t*r;for(let e=h().length-1;e>=0;e--){let t=h()[e].x*n,o=h()[e].y*r;if(Math.hypot(i-t,a-o)<=32)return h()[e]}return null}function Re(e,t){let n=K.getBoundingClientRect();p(ne,e-n.left),p(re,t-n.top),p(ie,!0),ae&&clearTimeout(ae),ae=setTimeout(()=>{p(ie,!1)},400)}function ze(e){j()||e.preventDefault()}function Be(e){if(j())return;let{nx:t,ny:r}=Ie(e.clientX,e.clientY),i=Le(t,r);if(n(I)&&n(L)!==null){if(i&&i.id!==n(L))return;Y();let a=e=>Math.max(.02,Math.min(.98,e));h(h().map(e=>e.id===n(L)?{...e,x:a(t),y:a(r)}:e)),Re(e.clientX,e.clientY),p(I,!1),p(L,null);let o=h().find(e=>e.id===n(P)?.id);o&&(p(P,{...o},!0),p(F,!0)),Z();return}if(i)n(P)&&n(P).id===i.id&&n(F)?He():Ve(i);else{if(n(F)){He();return}Re(e.clientX,e.clientY),Ue(t,r)}X()}function Ve(e){p(N,e.id,!0),p(P,{...e},!0),p(F,!0),p(J,!1),X()}function He(){p(F,!1),p(P,null),p(N,null),p(I,!1),p(L,null),p(J,!1),X()}function Ue(e,t){Y();let r=n(Oe),i={id:r,x:e,y:t,delay_ms:h().length>0?h()[h().length-1].delay_ms+25:0,label:String(r)};h().length>0&&T([...T(),{from:h()[h().length-1].id,to:r}]),h([...h(),i]),p(N,r,!0),p(P,{...i},!0),p(F,!0),p(J,!1),Z()}function We(){q&&Ue(.5,.5)}function Ge(){n(P)&&(Y(),h(h().map(e=>e.id===n(P).id?{...n(P)}:e)),Z(),p(N,n(P).id,!0))}function Ke(e){n(P)&&(p(P,{...n(P),delay_ms:Math.max(0,n(P).delay_ms+e)},!0),Ge())}function qe(){n(P)&&(p(L,n(P).id,!0),p(I,!0),p(F,!1),X())}function Je(){p(J,!0)}function Ye(){if(!n(P))return;Y();let e=n(P).id;h(h().filter(t=>t.id!==e)),T(T().filter(t=>t.from!==e&&t.to!==e)),He(),Z()}function Xe(){Y();let e=[],t=[],r=Math.max(1,Math.min(20,n(z))),i=Math.max(1,Math.min(20,n(B))),a=Math.max(0,n(V));function o(e,t,n,r){return{id:e,x:Math.max(.05,Math.min(.95,t)),y:Math.max(.05,Math.min(.95,n)),delay_ms:r*a,label:String(e)}}let s=1,c=0;if(n(R)===`ligne`)for(let n=0;n<i;n++){let r=i===1?.5:.1+n/(i-1)*.8;e.push(o(s,r,.5,c)),s>1&&t.push({from:s-1,to:s}),s++,c++}else if(n(R)===`grille`)for(let n=0;n<r;n++)for(let a=0;a<i;a++){let l=i===1?.5:.1+a/(i-1)*.8,u=r===1?.5:.1+n/(r-1)*.8;e.push(o(s,l,u,c)),a>0&&t.push({from:s-1,to:s}),s++,c++}else if(n(R)===`vcut`){let n=Math.max(2,r);for(let t=0;t<n;t++){let r=.15+t/(n-1)*.7,i=.45-t/(n-1)*.35;e.push(o(s,i,r,c)),s++,c++;let a=.55+t/(n-1)*.35;e.push(o(s,a,r,c)),s++,c++}for(let n=1;n<e.length;n++)t.push({from:e[n-1].id,to:e[n].id})}else if(n(R)===`echelon`){let n=i;for(let i=0;i<r;i++){let a=r===1?.5:.1+i/(r-1)*.8,l=i%2==1&&n>1?.4/(n-1):0;for(let r=0;r<n;r++){let i=n===1?.5:.1+l+r/(n-1)*(.8-l*2);e.push(o(s,i,a,c)),r>0&&t.push({from:s-1,to:s}),s++,c++}}}h(e),T(t),p(M,`none`),Z()}async function Ze(e){let t=e.target.files?.[0];if(t){p(U,``),p(H,!0);try{let e=(await te())?.gemini_api_key||``;if(!e){p(U,`Configure ta clé Gemini dans Profil`),p(H,!1);return}let n=await Qe(t),r=t.type||`image/jpeg`,i=await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${e}`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({contents:[{parts:[{text:`Analyze this blast drill pattern image. Extract all drill holes with their positions and timing delays.
...
Normalize positions to 0-1 range based on the image boundaries.`},{inlineData:{mimeType:r,data:n}}]}]})});if(!i.ok){let e=await i.json().catch(()=>({}));throw Error(e?.error?.message||`Erreur API: ${i.status}`)}let a=((await i.json())?.candidates?.[0]?.content?.parts?.[0]?.text||``).match(/\{[\s\S]*\}/);if(!a)throw Error(`Réponse invalide de Gemini`);let o=JSON.parse(a[0]);if(!o.holes||!Array.isArray(o.holes))throw Error(`Format de réponse inattendu`);Y();let s=o.holes.map((e,t)=>({id:t+1,x:Math.max(.05,Math.min(.95,Number(e.x)||.5)),y:Math.max(.05,Math.min(.95,Number(e.y)||.5)),delay_ms:Number(e.delay_ms)>=0?Number(e.delay_ms):0,label:e.label?String(e.label):String(t+1)})),c=[];for(let e=1;e<s.length;e++)c.push({from:s[e-1].id,to:s[e].id});h(s),T(c),p(M,`none`),Z()}catch(e){p(U,e?.message||`Erreur lors de l'importation`,!0)}finally{p(H,!1),n(W)&&(n(W).value=``)}}}function Qe(e){return new Promise((t,n)=>{let r=new FileReader;r.onload=()=>{let e=r.result;t(e.split(`,`)[1])},r.onerror=n,r.readAsDataURL(e)})}w(()=>{let e=new ResizeObserver(()=>Fe());return q&&e.observe(q),Fe(),()=>e.disconnect()}),c(()=>{h(),T(),X()}),c(()=>{n(N),n(I),X()}),c(()=>{K&&h().length>0&&!O()&&Z()});var $e=Ee(),et=u($e),tt=o(et),nt=e=>{var t=he(),r=u(t),i=o(r),a=A(i,2),c=A(a,2);l(r);var d=A(r,2),m=e=>{var t=de(),r=A(o(t),4),i=e=>{var t=ce(),r=o(t),i=A(r),a=e=>{k(e,se())},c=f(()=>n(U).includes(`Gemini`));g(i,e=>{n(c)&&e(a)}),l(t),s(()=>E(r,`⚠️ ${n(U)??``} `)),k(e,t)};g(r,e=>{n(U)&&e(i)});var a=A(r,2),c=e=>{k(e,le())},u=e=>{var t=ue(),r=A(o(t));C(r,e=>p(W,e),()=>n(W)),l(t),D(`change`,r,Ze),k(e,t)};g(a,e=>{n(H)?e(c):e(u,-1)}),l(t),k(e,t)};g(d,e=>{n(M)===`photo`&&e(m)});var h=A(d,2),_=e=>{var t=me(),r=A(o(t),2);x(r,20,()=>[{id:`ligne`,icon:`─`,label:`Ligne droite`,desc:`1 rangée`},{id:`grille`,icon:`⊞`,label:`Grille`,desc:`Rectangulaire`},{id:`vcut`,icon:`∨`,label:`V-cut / Bouchon`,desc:`Coupe en V`},{id:`echelon`,icon:`≋`,label:`Échelon`,desc:`Rangées décalées`}],ee,(e,t)=>{var r=fe(),i=o(r),a=o(i,!0);l(i);var c=A(i,2),u=o(c,!0);l(c);var d=A(c,2),f=o(d,!0);l(d),l(r),s(()=>{b(r,`
            ...
            ${n(R)===t.id?`background: var(--accent-glow); border-color: var(--accent); color: var(--accent2);`:`background: var(--card); border-color: var(--border); color: var(--text2);`}
          `),E(a,t.icon),E(u,t.label),E(f,t.desc)}),D(`click`,r,()=>p(R,t.id,!0)),k(e,r)}),l(r);var i=A(r,2),a=o(i),c=e=>{var t=pe(),r=A(o(t),2);S(r),l(t),y(r,()=>n(z),e=>p(z,e)),k(e,t)};g(a,e=>{n(R)!==`ligne`&&e(c)});var u=A(a,2),d=o(u),f=o(d,!0);l(d);var m=A(d,2);S(m),l(u);var h=A(u,2),_=A(o(h),2);S(_),l(h);var v=A(h,2),C=A(o(v),2);S(C),l(v);var w=A(v,2),T=A(o(w),2);S(T),l(w),l(i);var O=A(i,2);l(t),s(()=>E(f,n(R)===`ligne`?`Nb trous`:`Trous/rangée`)),y(m,()=>n(B),e=>p(B,e)),y(_,()=>n(oe),e=>p(oe,e)),y(C,()=>n(De),e=>p(De,e)),y(T,()=>n(V),e=>p(V,e)),D(`click`,O,Xe),k(e,t)};g(h,e=>{n(M)===`template`&&e(_)}),s(()=>{b(i,`
        flex: 1; min-width: 90px;
        padding: 10px 8px; border-radius: 8px; font-size: 12px; font-weight: 600;
        cursor: pointer; font-family: inherit; border: 1px solid;
        text-align: center;
        ${n(M)===`photo`?`background: var(--accent-glow); border-color: var(--accent); color: var(--accent2);`:`background: var(--card2); border-color: var(--border); color: var(--text2);`}
      `),b(a,`
        flex: 1; min-width: 90px;
        padding: 10px 8px; border-radius: 8px; font-size: 12px; font-weight: 600;
        cursor: pointer; font-family: inherit; border: 1px solid;
        text-align: center;
        ${n(M)===`template`?`background: var(--accent-glow); border-color: var(--accent); color: var(--accent2);`:`background: var(--card2); border-color: var(--border); color: var(--text2);`}
      `),b(c,`
        flex: 1; min-width: 90px;
        padding: 10px 8px; border-radius: 8px; font-size: 12px; font-weight: 600;
        cursor: pointer; font-family: inherit; border: 1px solid;
        text-align: center;
        ${n(M)===`none`?`background: var(--accent-glow); border-color: var(--accent); color: var(--accent2);`:`background: var(--card2); border-color: var(--border); color: var(--text2);`}
      `)}),D(`click`,i,()=>p(M,n(M)===`photo`?`none`:`photo`,!0)),D(`click`,a,()=>p(M,n(M)===`template`?`none`:`template`,!0)),D(`click`,c,()=>{p(M,`none`)}),k(e,t)};g(tt,e=>{j()||e(nt)});var rt=A(tt,2),it=e=>{var t=ge(),n=A(o(t));l(t),D(`click`,n,()=>{p(I,!1),p(L,null),p(F,!0),X()}),k(e,t)};g(rt,e=>{n(I)&&e(it)});var Q=A(rt,2),$=o(Q);C($,e=>K=e,()=>K);var at=A($,2),ot=e=>{var t=_e();s(()=>b(t,`
        position: absolute;
        left: ${n(ne)-20}px;
        top: ${n(re)-20}px;
      ...
      `)),k(e,t)};g(at,e=>{n(ie)&&e(ot)});var st=A(at,2),ct=e=>{k(e,ve())};g(st,e=>{h().length===0&&!j()&&!n(I)&&e(ct)}),l(Q),C(Q,e=>q=e,()=>q);var lt=A(Q,2),ut=e=>{var t=xe(),r=o(t),i=o(r);l(r);var a=A(r,2),c=e=>{var t=v();x(u(t),17,()=>h().filter(e=>e.id===n(N)),ee,(e,t)=>{var r=ye(),i=o(r);l(r),s(()=>E(i,`· Trou ${n(t).label??``} — panneau ouvert`)),k(e,r)}),k(e,t)},d=e=>{k(e,be())};g(a,e=>{n(N)!==null&&n(F)?e(c):j()||e(d,1)}),l(t),s(()=>E(i,`${h().length??``} trou${h().length>1?`s`:``}`)),k(e,t)};g(lt,e=>{h().length>0&&!n(I)&&e(ut)});var dt=A(lt,2),ft=e=>{var t=Se(),n=o(t),r=A(n,2),i=A(r,2),a=A(i,2),c=A(a,2);l(t),s(()=>{r.disabled=h().length===0,b(r,`
        flex: 1; min-width: 60px;
        padding: 9px 6px; border-radius: 8px; font-size: 11px; font-weight: 600;
        background: var(--card2); border: 1px solid var(--border);
      ...
      `),c.disabled=h().length===0,b(c,`
        ...
        cursor: ${h().length===0?`default`:`pointer`}; font-family: inherit; text-align: center;
      `)}),D(`click`,n,We),D(`click`,r,je),D(`click`,i,Me),D(`click`,a,ke),D(`click`,c,Ae),k(e,t)};g(dt,e=>{!j()&&!n(I)&&e(ft)}),l(et);var pt=A(et,2),mt=e=>{var t=Te(),r=A(o(t),2),i=o(r),a=o(i);l(i);var c=A(i,2);l(r);var d=A(r,2),f=o(d),m=A(o(f),2),h=o(m),_=A(h,2),v=A(_,2);S(v);var b=A(v,2),ee=A(b,2);l(m),l(f);var x=A(f,2),C=A(o(x),2);S(C),l(x);var w=A(x,2),T=o(w),O=A(T,2),te=e=>{var t=Ce();D(`click`,t,Je),k(e,t)},j=e=>{var t=we(),n=u(t),r=A(n,2);D(`click`,n,Ye),D(`click`,r,()=>p(J,!1)),k(e,t)};g(O,e=>{n(J)?e(j,-1):e(te)}),l(w),l(d),l(t),s(()=>E(a,`✏️ Trou ${n(P).label??``}`)),D(`click`,c,He),D(`click`,h,()=>Ke(-25)),D(`click`,_,()=>Ke(-5)),D(`input`,v,Ge),y(v,()=>n(P).delay_ms,e=>n(P).delay_ms=e),D(`click`,b,()=>Ke(5)),D(`click`,ee,()=>Ke(25)),D(`input`,C,Ge),y(C,()=>n(P).label,e=>n(P).label=e),D(`click`,T,qe),k(e,t)};g(pt,e=>{n(F)&&n(P)&&!j()&&e(mt)}),s(()=>b(Q,`
      position: relative; width: 100%; border-radius: 8px; overflow: hidden;
      border: ${n(I)?`2px solid #f5c518`:`1px solid var(--border)`};
      cursor: ${j()?`default`:n(I)?`crosshair`:`pointer`};
      touch-action: none;
    `)),D(`pointerdown`,$,function(...e){(j()?void 0:ze)?.apply(this,e)}),D(`pointerup`,$,function(...e){(j()?void 0:Be)?.apply(this,e)}),d(`pointercancel`,$,function(...e){(j()?void 0:Be)?.apply(this,e)}),k(t,$e),a()}t([`click`,`change`,`pointerdown`,`pointerup`,`input`]);export{oe as n,De as t};